        ...
        <div className="flex flex-col items-center justify-center p-8">
            ...
            <div className="flex flex-wrap justify-around w-full md:w-2/3">
                <div className="flex-1">
                    <h2 className="text-2xl font-semibold text-gray-700 m-4">Ingredientes</h2>
                    <ul className="list-disc pl-5">
                        {ingredientes && ingredientes.conteudo.map((item, index) => (
                            <li key={index} className="text-gray-600 m-4">{item}</li>
                        ))}
                    </ul>
                </div>
                <div className="flex-1">
                    <h2 className="text-2xl font-semibold text-gray-700 m-4">Modo de Preparo</h2>
                    <ul className="list-disc pl-5">
